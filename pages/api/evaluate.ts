...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    const system = `You are an expert trading performance evaluator. Review historical AI trading decisions and provide constructive feedback. Respond in JSON only with the shape {"overview":"string","what_went_well":["..."],"issues":["..."],"improvements":["..."],"confidence":"LOW|MEDIUM|HIGH"}. Focus on how well the prompt/market snapshot aligns with the action taken and note concrete improvements.`;
