...
async function main() {
    ...
    const [deployments, sessions, executionRuns, journal, tradeLedger, cycles, tasks, attempts, cooldowns, jobs, shadowJobRuns] =
        await Promise.all([
            ...
            countTable('scalp_research_cycles'),
            countTable('scalp_research_tasks'),
            countTable('scalp_research_attempts'),
